...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const populatePageContent = () => {
    ...
    const creator = settings.apiSettings?.creator || "FieX Api'S"

    setPageContent(DOM.pageTitle, settings.name, "FieX Api'S")
    setPageContent(DOM.wm, `© ${currentYear} FieX Api'S Corp. All rights reversed.`)
    setPageContent(DOM.appName, settings.name, "FieX Api'S")
